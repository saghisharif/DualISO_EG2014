...
public:
  ...
  std::vector<FileMap*> ownedObjects;
...
protected:
  ...
  bool checkCameraSupported(CameraMetaData *meta, std::string make, std::string model, std::string mode);
  ...
  virtual void setMetaData(CameraMetaData *meta, std::string make, std::string model, std::string mode, int iso_speed = 0);
